...
function showProperties(){
    $("#property-values").jsGrid({
        ...
        fields: [
           ...
           // { name: "percentage", type: "number", align: "center", readOnly: true,title: "比重" },
            { name: "alpha", type: "number", align: "center", title: "alpha" },
            { name: "beta", type: "number", align: "center", title: "beta" },
            { name: "gamma", type: "number", align: "center", title: "gamma" },
            { name: "delte", type: "number", align: "center", title: "delte" },
            { name: "epsilon", type: "number", align: "center", title: "epsilon" },
            { name: "zeta", type: "number", align: "center", title: "zeta" },
            { name: "eta", type: "number", align: "center", title: "eta" },
            { name: "theta", type: "number", align: "center", title: "theta" },
            { type: "control" }
        ]
    });
